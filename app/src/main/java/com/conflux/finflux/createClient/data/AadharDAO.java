...
// put your XML value into the sStringToParse variable
    ...
    //To set the parsed xml Values to aadhar details
    public void setAadharDetails(String attrName, String attrValue) {
        ...
        if (attrName.equals("co")) {
            ad.setCo(attrValue);
        }
        if (attrName.equals("house")) {
            ad.setHouse(attrValue);
        }
        if (attrName.equals("loc")) {
            ad.setLoc(attrValue);
        }
        if (attrName.equals("street")) {
            ad.setStreet(attrValue);
        }
        if (attrName.equals("subdist")) {
            ad.setSubdist(attrValue);
        }
    }
}
